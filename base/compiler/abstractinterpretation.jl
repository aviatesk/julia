...
function abstract_call_gf_by_type(interp::AbstractInterpreter, @nospecialize(f),
    ...
    for i in 1:napplicable
        ...
        if splitunions
            ...
            this_rt = widenwrappedslotwrapper(result.rt)
            edge = result.edge
            edge !== nothing && push!(edges, edge)
            ...
            if const_call_result !== nothing
                ...
                this_const_rt = widenwrappedslotwrapper(const_call_result.rt)
        ...
        @assert !(this_conditional isa Conditional || this_conditional isa MustAlias) "invalid lattice element returned from inter-procedural context"
        seen += 1
            ...
            if rt !== Bottom && !isa(rt, Const)
                ...
                if isa(var, SlotNumber)
                    ...
                    if has_alias_field(argtyp)
                        ...
                        return MustAlias(var, argtyp, a3, rt)
                    end
                end
            end
        end
